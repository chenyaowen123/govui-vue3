...
const E = /* @__PURE__ */ Object.assign({
  ...
  setup(i, { emit: s }) {
    const t = i, u = a(() => t.mode === "time"), c = a(() => t.mode === "week"), m = a(() => t.mode === "month"), p = a(() => t.mode === "year"), e = V("govFormItem", null), l = s, r = a({
      get() {
        return t.modelValue;
      },
      set(n) {
        l("update:modelValue", n), l("change"), t.triggerForm && (e == null || e.$emit("change"));
      }
    });
    x(e, t, (n) => {
    ...
    return (n, d) => (g(), z("div", {
      ...
      style: $(i.width ? `width: ${t.width}px;` : "")
    }, [
      S(T(v), C({
        locale: "zh-CN",
