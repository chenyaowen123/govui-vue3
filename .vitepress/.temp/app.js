...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"GovUI","description":"政府系统专用UI","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":false,"themeConfig":{"logo":"/logo.png","nav":[{"text":"首页","link":"/"},{"text":"指南","link":"/guide/"},{"text":"组件","link":"/component/button/"}],"sidebar":{"/component/":[{"text":"开发指南","items":[{"text":"设计原则","link":"/guide/design"},{"text":"安装","link":"/guide/installation"},{"text":"快速上手","link":"/guide/quickstart"},{"text":"自定义主题","link":"/guide/color"},{"text":"Typography 字体","link":"/guide/typography"}]},{"text":"组件","items":[{"text":"规范化","items":[{"text":"Guoqi 国旗","link":"/component/guoqi/"},{"text":"Guohui 国徽","link":"/component/guohui/"},{"text":"Dangqi 党旗","link":"/component/dangqi/"},{"text":"Danghui 党徽","link":"/component/danghui/"}]},{"text":"基础组件","items":[{"text":"Grid 栅格化","link":"/component/grid/"},{"text":"Container 布局容器","link":"/component/container/"},{"text":"Icon 图标","link":"/component/icon/"},{"text":"Button 按钮","link":"/component/button/"},{"text":"Link 文本链接","link":"/component/link/"},{"text":"Alert 警告","link":"/component/alert/"},{"text":"Blockquote 引用","link":"/component/blockquote/"},{"text":"Tag 标签","link":"/component/tag/"},{"text":"Ellipsis 文本折叠","link":"/component/ellipsis/"},{"text":"Loading 加载","link":"/component/loading/"}]},{"text":"表单","items":[{"text":"Radio 单选框","link":"/component/radio/"},{"text":"Checkbox 多选框","link":"/component/checkbox/"},{"text":"Input 输入框","link":"/component/input/"},{"text":"InputAuto 自动补全","link":"/component/inputauto/"},{"text":"InputNumber 计数器","link":"/component/inputnumber/"},{"text":"Textarea 文本域","link":"/component/textarea/"},{"text":"Select 选择器","link":"/component/select/"},{"text":"Cascader 级联选择器","link":"/component/cascader/"},{"text":"CascaderPanel 级联面板","link":"/component/cascaderpanel/"},{"text":"Switch 开关","link":"/component/switch/"},{"text":"Datepicker 日期选择器","link":"/component/datepicker/"},{"text":"Upload 上传","link":"/component/upload/"},{"text":"Rate 评分","link":"/component/rate/"},{"text":"Editor 富文本","link":"/component/link/"},{"text":"Form 表单","link":"/component/form/"}]},{"text":"弹出","items":[{"text":"Drawer 抽屉","link":"/component/drawer/"},{"text":"Dialog 对话框","link":"/component/dialog/"},{"text":"Message 消息提示","link":"/component/message/"},{"text":"MessageBox 消息弹框","link":"/component/messagebox/"},{"text":"Popper 弹窗","link":"/component/popper/"},{"text":"Popconfirm 气泡确认框","link":"/component/popconfirm/"},{"text":"Tooltip 文字提示","link":"/component/tooltip/"},{"text":"Notification 通知","link":"/component/notification/"}]},{"text":"数据","items":[{"text":"Avatar 头像","link":"/component/avatar/"},{"text":"Usercard 人员信息卡","link":"/component/usercard/"},{"text":"Badge 标记","link":"/component/badge/"},{"text":"Card 卡片","link":"/component/card/"},{"text":"Collapse 折叠面板","link":"/component/collapse/"},{"text":"Empty 空状态","link":"/component/empty/"},{"text":"Pagination 分页","link":"/component/pagination/"},{"text":"Progress 进度条","link":"/component/progress/"},{"text":"Result 结果","link":"/component/result/"},{"text":"Table 表格","link":"/component/table/"},{"text":"Swiper 轮播","link":"/component/swiper/"},{"text":"Timeline 时间线","link":"/component/timeline/"},{"text":"Tree 树形控件","link":"/component/tree/"}]},{"text":"导航","items":[{"text":"Backtop 回到顶部","link":"/component/backtop/"},{"text":"Breadcrumb 面包屑","link":"/component/breadcrumb/"},{"text":"Dropdown 下拉菜单","link":"/component/dropdown/"},{"text":"Menu 菜单","link":"/component/link/"},{"text":"PageContainer 页面容器","link":"/component/pagecontainer/"},{"text":"Steps 步骤条","link":"/component/steps/"},{"text":"Tabs 标签页","link":"/component/tabs/"}]},{"text":"其它","items":[{"text":"Qrcode 二维码","link":"/component/qrcode/"}]}]}],"/guide/":[{"text":"开发指南","items":[{"text":"设计原则","link":"/guide/design"},{"text":"安装","link":"/guide/installation"},{"text":"快速上手","link":"/guide/quickstart"},{"text":"自定义主题","link":"/guide/color"},{"text":"Typography 字体","link":"/guide/typography"}]},{"text":"组件","items":[{"text":"规范化","items":[{"text":"Guoqi 国旗","link":"/component/guoqi/"},{"text":"Guohui 国徽","link":"/component/guohui/"},{"text":"Dangqi 党旗","link":"/component/dangqi/"},{"text":"Danghui 党徽","link":"/component/danghui/"}]},{"text":"基础组件","items":[{"text":"Grid 栅格化","link":"/component/grid/"},{"text":"Container 布局容器","link":"/component/container/"},{"text":"Icon 图标","link":"/component/icon/"},{"text":"Button 按钮","link":"/component/button/"},{"text":"Link 文本链接","link":"/component/link/"},{"text":"Alert 警告","link":"/component/alert/"},{"text":"Blockquote 引用","link":"/component/blockquote/"},{"text":"Tag 标签","link":"/component/tag/"},{"text":"Ellipsis 文本折叠","link":"/component/ellipsis/"},{"text":"Loading 加载","link":"/component/loading/"}]},{"text":"表单","items":[{"text":"Radio 单选框","link":"/component/radio/"},{"text":"Checkbox 多选框","link":"/component/checkbox/"},{"text":"Input 输入框","link":"/component/input/"},{"text":"InputAuto 自动补全","link":"/component/inputauto/"},{"text":"InputNumber 计数器","link":"/component/inputnumber/"},{"text":"Textarea 文本域","link":"/component/textarea/"},{"text":"Select 选择器","link":"/component/select/"},{"text":"Cascader 级联选择器","link":"/component/cascader/"},{"text":"CascaderPanel 级联面板","link":"/component/cascaderpanel/"},{"text":"Switch 开关","link":"/component/switch/"},{"text":"Datepicker 日期选择器","link":"/component/datepicker/"},{"text":"Upload 上传","link":"/component/upload/"},{"text":"Rate 评分","link":"/component/rate/"},{"text":"Editor 富文本","link":"/component/link/"},{"text":"Form 表单","link":"/component/form/"}]},{"text":"弹出","items":[{"text":"Drawer 抽屉","link":"/component/drawer/"},{"text":"Dialog 对话框","link":"/component/dialog/"},{"text":"Message 消息提示","link":"/component/message/"},{"text":"MessageBox 消息弹框","link":"/component/messagebox/"},{"text":"Popper 弹窗","link":"/component/popper/"},{"text":"Popconfirm 气泡确认框","link":"/component/popconfirm/"},{"text":"Tooltip 文字提示","link":"/component/tooltip/"},{"text":"Notification 通知","link":"/component/notification/"}]},{"text":"数据","items":[{"text":"Avatar 头像","link":"/component/avatar/"},{"text":"Usercard 人员信息卡","link":"/component/usercard/"},{"text":"Badge 标记","link":"/component/badge/"},{"text":"Card 卡片","link":"/component/card/"},{"text":"Collapse 折叠面板","link":"/component/collapse/"},{"text":"Empty 空状态","link":"/component/empty/"},{"text":"Pagination 分页","link":"/component/pagination/"},{"text":"Progress 进度条","link":"/component/progress/"},{"text":"Result 结果","link":"/component/result/"},{"text":"Table 表格","link":"/component/table/"},{"text":"Swiper 轮播","link":"/component/swiper/"},{"text":"Timeline 时间线","link":"/component/timeline/"},{"text":"Tree 树形控件","link":"/component/tree/"}]},{"text":"导航","items":[{"text":"Backtop 回到顶部","link":"/component/backtop/"},{"text":"Breadcrumb 面包屑","link":"/component/breadcrumb/"},{"text":"Dropdown 下拉菜单","link":"/component/dropdown/"},{"text":"Menu 菜单","link":"/component/link/"},{"text":"PageContainer 页面容器","link":"/component/pagecontainer/"},{"text":"Steps 步骤条","link":"/component/steps/"},{"text":"Tabs 标签页","link":"/component/tabs/"}]},{"text":"其它","items":[{"text":"Qrcode 二维码","link":"/component/qrcode/"}]}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/chenyaowen123/govui-vue3"}],"footer":{"message":"Released under the MIT License."}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Layout2), _attrs, {
        "home-hero-image": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "position": "absolute", "z-index": "999" })}"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/theme/component/MyLayout.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["demo-container", [{ "is-transparent": __props.transparent }]]
      }, _attrs))} data-v-48a237ee><div class="vp-raw" data-v-48a237ee>`);
      ...
      _push(`</div>`);
      if (_ctx.$slots.console) {
        _push(`<div class="language-js" data-v-48a237ee><div class="right" data-v-48a237ee>控制台</div><pre data-v-48a237ee><code data-v-48a237ee>`);
        ssrRenderSlot(_ctx.$slots, "console", {}, null, _push, _parent);
        _push(`</code></pre></div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/theme/component/demoContainer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const demoContainer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-48a237ee"]]);
const RawTheme = {
  extends: theme,
  Layout: () => {
    return h(_sfc_main$1, null, {
