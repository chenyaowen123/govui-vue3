...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_gov_guohui = resolveComponent("gov-guohui");
      _push(ssrRenderComponent(_component_demo_container, mergeProps({ class: "gov-demo-avatar" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<hr${_scopeId}>`);
            _push2(ssrRenderComponent(_component_gov_guohui, { width: width.value }, null, _parent2, _scopeId));
          } else {
            return [
              ...
              createVNode("hr"),
              createVNode(_component_gov_guohui, { width: width.value }, null, 8, ["width"])
            ];
          }
        }),
        _: 1
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("component/standard/guohui/guohui-base.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __pageData = JSON.parse('{"title":"Guohui 国徽","description":"","frontmatter":{},"headers":[],"relativePath":"component/guohui/index.md","filePath":"component/standard/guohui/index.md"}');
const __default__ = { name: "component/guohui/index.md" };
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="guohui-国徽" tabindex="-1">Guohui 国徽 <a class="header-anchor" href="#guohui-国徽" aria-label="Permalink to &quot;Guohui 国徽&quot;">​</a></h1><p>快速引用一个符合标准的国徽图片，该组件有助于规范化、标准化。</p><h2 id="国徽法规范" tabindex="-1">国徽法规范 <a class="header-anchor" href="#国徽法规范" aria-label="Permalink to &quot;国徽法规范&quot;">​</a></h2><p>《中华人民共和国国徽法》是为了维护国徽的尊严，正确使用国徽，增强公民的国家观念，弘扬爱国主义精神，培育和践行社会主义核心价值观，根据宪法，制定的法律。</p><p>2020年10月17日，十三届全国人大常委会第二十二次会议表决通过关于修改国旗法、国徽法的决定，决定于2021年1月1日起施行。</p><h2 id="基础使用" tabindex="-1">基础使用 <a class="header-anchor" href="#基础使用" aria-label="Permalink to &quot;基础使用&quot;">​</a></h2>`);
...
<span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">	&lt;</span><span style="${ssrRenderStyle({ "--shiki-light": "#22863A", "--shiki-dark": "#85E89D" })}">gov-guohui</span><span style="${ssrRenderStyle({ "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" })}"> :width</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">=</span><span style="${ssrRenderStyle({ "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" })}">&quot;width&quot;</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}"> /&gt;</span></span>
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("component/standard/guohui/index.md");
